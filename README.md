...
[![GitHub release](https://img.shields.io/github/release/rook/nfs/all.svg)](https://github.com/rook/nfs/releases)
...
Official releases of Rook can be found on the [releases page](https://github.com/rook/nfs/releases).

...
The release branch is not by default created as "protected", so remember to go to the [branch settings](https://github.com/rook/nfs/settings/branches) and mark it as "protected".
...
When the release is nearing completion, start a new release "draft" by going to https://github.com/rook/nfs/releases/new and start with the content from the pending release notes.

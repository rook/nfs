...
import (
	...
	v1alpha1 "github.com/rook/nfs/pkg/apis/nfs.rook.io/v1alpha1"
...
func (c *FakeNFSServers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NFSServer, err error) {
	obj, err := c.Fake.
...
func (c *FakeNFSServers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NFSServerList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.NFSServerList{ListMeta: obj.(*v1alpha1.NFSServerList).ListMeta}
...
func (c *FakeNFSServers) Create(ctx context.Context, nFSServer *v1alpha1.NFSServer, opts v1.CreateOptions) (result *v1alpha1.NFSServer, err error) {
	obj, err := c.Fake.
...
func (c *FakeNFSServers) Update(ctx context.Context, nFSServer *v1alpha1.NFSServer, opts v1.UpdateOptions) (result *v1alpha1.NFSServer, err error) {
	obj, err := c.Fake.
...
func (c *FakeNFSServers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NFSServer, err error) {
	obj, err := c.Fake.
